...
func TestWordStream(t *testing.T) {
	...
	tests_ends := [][]string{
		...
		[]string{"привет, мир", "привет", WS_COMMA, "мир", "."},
		...
		[]string{"группа Ёрш.", "группа", "ерш", "."},
		[]string{"испания . часть первая", "испания", ".", "часть", "первая", "."},
		[]string{"ставь #хэштег#хештег тег? #мояцлица друг https://yandex.ru", "ставь", "тег", ".", "друг", "."},
		[]string{"2*2=4 это знают в целом мире, да https://yandex.ru ?", "2", "2", "4", "это", "знают", "в", "целом", "мире", WS_COMMA, "да", "."},
	}
	...
	test_nonums := [][]string{
		...
		[]string{"132*2.1478=4.0 это знают в целом мире, да https://yandex.ru ?", "это", "знают", "в", "целом", "мире", WS_COMMA, "да", "."},
	}
	...
	test_nonums_hashtags := [][]string{
		...
		[]string{"132*2.1478=4.0 это знают в целом мире, ххх: да https://yandex.ru ? #тест", "это", "знают", "в", "целом", "мире", WS_COMMA, "да", ".", "тест", "."},
	}
