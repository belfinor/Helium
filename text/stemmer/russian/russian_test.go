...
func Test_stopWords(t *testing.T) {
	...
	RunWordBoolTest(t, isStopWord, testCases)
}

func Test_findRegions(t *testing.T) {
	testCases := []FindRegionsTestCase{
		{"кистей", 3, 6, 2},
		{"пугает", 3, 6, 2},
		{"горячей", 3, 5, 2},
	...
	RunFindRegionsTest(t, findRegions, testCases)
}
